...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `도심 최중심 998세대 랜드마크`,
    text2: `전용 84·105·119㎡ 다양 구성<br/>
            지하5~지상49층, 6개 동(선화 재개발 최전면)`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `더블역세권·트램 프리미엄`,
    text2: `대전역·서대전역 접근, 1호선 중앙로역 생활권<br/>
            트램(2호선 예정)·대종로/순환도로로 편리한 이동`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `행정·의료·생활 원스톱`,
    text2: `중구청·대전중부경찰서 인접(주변)<br/>
            대전성모병원·선병원·NC백화점·지하상가·중앙시장`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `자연·휴식 특화 환경`,
    text2: `보문산·선화양지공원 접근성 우수<br/>
            단지 내 공원형 조경으로 힐링 라이프`,
    link: "/LocationEnvironment/primium", // 의도 유지
    linkText: "더 알아보기 >",
  },
];
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            <img
              ...
              alt="대전 하늘채 루시에르-mainimage1"
            />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox}>
            <div className={styles.mainImageTextSub}>
              코오롱글로벌 하늘채의 <span className={styles.highlightText}>신뢰와 가치가 빛나는</span>{" "}
              <span className={styles.greyText}>브랜드 프리미엄</span>
            </div>
            <div className={styles.mainImageTitleBox}>
              <div className={styles.mainImageText}>도심 최중심, 미래 프리미엄의 시작</div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 도시철도 1호선·2호선 트램(예정)과 대전역·서대전역 더블역세권으로 뛰어난 광역 접근성<br />
                  - 문화거리, 중앙시장, NC백화점·지하상가 등 도심 원스톱 생활 인프라<br />
                  - 선화초 도보 생활권, 충남여중·충남여고·대성중·대성고 인접으로 우수한 교육 환경<br />
                  - 보문산·선화양지공원 등 도심 녹지축과 가까운 쾌적한 주거 환경<br />
                  - 대규모 브랜드 타운 시너지, 총 998세대 랜드마크 프리미엄
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="대전 하늘채 루시에르 아파트 조감도-image3"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="대전 하늘채 루시에르 오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="대전 하늘채 루시에르 mobilemain-image1"
            />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox1}>
            <div className={styles.mainImageTextSub1}>
              도심 최중심 선화동에서 시작되는<br/> 새로운 주거 기준, 높은 미래가치<br/>
              대전 하늘채 루시에르가<br/> 제시하는 프리미엄 라이프<br />
              <span className={styles.greyText1}>하늘채 브랜드 프리미엄</span>
              <br />
            </div>
          ...
          <div className={styles.container1}>
            ...
            <div className={styles.text3}>
                  - 도시철도 1호선·2호선 트램과 대전역더블역세권으로 광역 접근성<br />
                  - 문화거리, 중앙시장, NC백화점·지하상가 등 도심 원스톱 생활 인프라<br />
                  - 선화초 도보 생활권, 중·고인접으로 우수한 교육 환경<br />
                  - 보문산·선화양지공원 등 도심 녹지축과 가까운 쾌적한 주거 환경<br />
                  - 대규모 브랜드 타운 시너지, 총 998세대 랜드마크 프리미엄
                </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 대전 하늘채 루시에르에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="대전 하늘채 루시에르 모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="대전 하늘채 루시에르 브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="대전 하늘채 루시에르 오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
