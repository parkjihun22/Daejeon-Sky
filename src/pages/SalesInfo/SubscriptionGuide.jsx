...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
        <Helmet>
          <title>대전 하늘채 루시에르 - 정당계약안내</title>
          <meta
            name="description"
            content="대전 하늘채 루시에르 청약방법을 확인하세요. 청약 자격, 신청 절차, 준비서류 및 유의사항을 단계별로 상세히 안내합니다."
          />
        ...
        <p className={styles.screenReaderOnly}>
          대전 하늘채 루시에르 정당계약안내 페이지에서는 청약 자격 조건, 신청 절차,
