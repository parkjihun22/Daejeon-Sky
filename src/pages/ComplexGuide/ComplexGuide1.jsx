...
import page1 from "../../assets/ComplexGuide/ComplexGuide1/page1.webpm";
...
const ComplexGuide1 = () => {
	...
	return (
		<div className={styles.container}>
			<Helmet>
			{/* 간소화 Helmet: title / description / canonical / robots 만 유지 */}
			<title>대전 하늘채 루시에르 - 단지배치도</title>
			<meta
				name="description"
				content="대전 하늘채 루시에르 단지배치도를 통해 동 배치, 조경, 커뮤니티 시설, 주차·보행 동선 설계를 확인하세요. 남향 위주 배치와 넓은 동간거리로 쾌적한 생활을 제공합니다."
			/>
			...
			{/* SEO: 페이지 제목/설명 */}
			<h1 className={styles.screenReaderOnly}>대전 하늘채 루시에르 - 단지배치도</h1>
			<p className={styles.screenReaderOnly}>
			단지 배치도 페이지는 대전 하늘채 루시에르의 전체 단지 구성도를 제공합니다.
			...
			<div>쾌적함을 설계한 배치</div>
			<div>대전 하늘채 루시에르, 공원형 단지의 일상을 누리다</div>
			</div>
