...
const BusinessGuide2 = () => {
	...
	return (
		<div className={styles.container}>
			...
			{/* SEO: 페이지 제목/설명 */}
			<h1 className={styles.screenReaderOnly}>대전 하늘채 루시에르 - 계약서류안내</h1>
			<p className={styles.screenReaderOnly}>
			대전 하늘채 루시에르 계약서류안내 페이지에서는 분양 당첨 후 필요한 서류를 정리해 드립니다.
			...
			<div>계약을 위한 첫 걸음</div>
			<div>대전 하늘채 루시에르, 준비된 서류로 안심 계약하세요.</div>
			</div>



			{/* 이미지에 isImageVisible 상태 적용 */}
			{/* <img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="대전 하늘채 루시에르 계약서류안내-image1" /> */}
