...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/xkgopypr", {
        method: "POST",
  ...
  return (
    ...
    <>
      <Helmet>
        ...
        <title>대전 하늘채 루시에르 - 관심고객등록</title>
        <meta
          name="description"
          content="대전 하늘채 루시에르 관심고객 등록 시 모델하우스 방문 예약 알림, 위치 및 현장 정보, 분양 일정과 혜택을 가장 먼저 받아보실 수 있습니다."
        />
        <meta name="robots" content="index,follow" />
        <link rel="canonical" href="https://intercs.co.kr/Promotion/Customer" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="대전 하늘채 루시에르" />
        <meta property="og:title" content="대전 하늘채 루시에르 - 관심고객등록" />
        <meta
          property="og:description"
          content="관심고객 등록하고 대전 하늘채 루시에르 모델하우스 오픈, 청약·계약 일정, 위치/현장 소식을 가장 먼저 받아보세요."
        />
        <meta property="og:url" content="https://intercs.co.kr/Promotion/Customer" />
        <meta property="og:image" content="https://intercs.co.kr/img/og/customer.jpg" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="대전 하늘채 루시에르 - 관심고객등록" />
        <meta
          name="twitter:description"
          content="관심고객 등록 시 모델하우스 예약 알림, 위치/현장 정보, 분양 일정 등을 가장 먼저 안내드립니다."
        />
        <meta name="twitter:image" content="https://intercs.co.kr/img/og/customer.jpg" />
        <meta name="twitter:url" content="https://intercs.co.kr/Promotion/Customer" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebPage",
            name: "대전 하늘채 루시에르 - 관심고객등록",
            url: "https://intercs.co.kr/Promotion/Customer",
            description:
              "대전 하늘채 루시에르 관심고객 등록 시 모델하우스 방문 예약 알림과 위치/현장 정보, 분양 일정을 사전에 안내받을 수 있습니다.",
            primaryImageOfPage: {
              "@type": "ImageObject",
              contentUrl: "https://intercs.co.kr/img/og/customer.jpg",
              width: 1200,
              height: 630
            },
            breadcrumb: {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 2, name: "관심고객등록", item: "https://intercs.co.kr/Promotion/Customer" }
              ]
            }
          })}
        </script>
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>대전 하늘채 루시에르</h2>
